# -*- coding: utf-8 -*-
"""
Created on Thu Feb  2 14:21:31 2023
...
class DenseNet(nn.Module):
    def __init__(
        self, num_input_layers = 3,num_classes=10, num_layers=[6, 12], bn_size=2, growth_rate=32, act_fn_name="relu",lin_size=3584,bin_size=[1,2,4], **kwargs
    ):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = DenseNet(num_input_layers = 4,num_classes=6, num_layers=[6, 12], bn_size=2, growth_rate=32,lin_size=3584, act_fn_name="relu",bin_size=[6,3,2]).cuda()
    summary(model, input_size=(4, 50, 50))